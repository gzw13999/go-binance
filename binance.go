...
type Binance interface {
	...
	// NewOrder places new order and returns ProcessedOrder.
	NewOrderFull(nor NewOrderRequest) (*ProcessedOrderFull, error)
...
type ProcessedOrderFull struct {
	Symbol              string    `json:"symbol"`
...
// NewOrder places new order and returns ProcessedOrder.
func (b *binance) NewOrderFull(nor NewOrderRequest) (*ProcessedOrderFull, error) {
	return b.Service.NewOrderFull(nor)
}
